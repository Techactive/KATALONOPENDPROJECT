...
WebUI.setText(findTestObject('Object Repository/NEWOPENDCPM/Page_Opend/input_Campaign Name_camp_name_'), 'CPM WITH A/B SPLIT CAMPAIGN ')
...
WebUI.click(findTestObject('NEWSPYIDS/Page_Opend/label_AB Split'))
